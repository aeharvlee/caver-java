...
public class FeeDelegatedValueTransferMemoWrapper {
     ...
     * @return FeeDelegatedValueTransferMemo
     */
    public FeeDelegatedValueTransferMemo create(String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String to, String value, String input) {
        return FeeDelegatedValueTransferMemo.create(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, to, value, input);
    }
