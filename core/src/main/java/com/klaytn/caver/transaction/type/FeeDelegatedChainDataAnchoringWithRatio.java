...
public class FeeDelegatedChainDataAnchoringWithRatio extends AbstractFeeDelegatedWithRatioTransaction {
     ...
     * @return FeeDelegatedChainDataAnchoringWithRatio
     */
    public static FeeDelegatedChainDataAnchoringWithRatio create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio, String input) {
        return new FeeDelegatedChainDataAnchoringWithRatio(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, feeRatio, input);
    }
     ...
     * @param input The data of the service chain.
     */
    public FeeDelegatedChainDataAnchoringWithRatio(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio, String input) {
        super(
                klaytnCall,
