...
public class FeeDelegatedSmartContractExecution extends AbstractFeeDelegatedTransaction {
     ...
     * @return FeeDelegatedSmartContractExecution
     */
    public static FeeDelegatedSmartContractExecution create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String to, String value, String input) {
        return new FeeDelegatedSmartContractExecution(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, to, value, input);
    }
     ...
     * @param input The data attached to the transaction, used for transaction execution.
     */
    public FeeDelegatedSmartContractExecution(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String to, String value, String input) {
        super(
                klaytnCall,
