...
public class FeeDelegatedCancelWithRatio extends AbstractFeeDelegatedWithRatioTransaction {
     ...
     * @return FeeDelegatedCancelWithRatio
     */
    public static FeeDelegatedCancelWithRatio create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio) {
        return new FeeDelegatedCancelWithRatio(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, feeRatio);
    }
     ...
     * @param feeRatio A fee ratio of the fee payer.
     */
    public FeeDelegatedCancelWithRatio(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio) {
        super(klaytnCall, TransactionType.TxTypeFeeDelegatedCancelWithRatio.toString(), from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, feeRatio);
    }
