...
public class FeeDelegatedValueTransferMemo extends AbstractFeeDelegatedTransaction {
     ...
     * @return FeeDelegatedValueTransferMemo
     */
    public static FeeDelegatedValueTransferMemo create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String to, String value, String input) {
        return new FeeDelegatedValueTransferMemo(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, to, value, input);
    }
     ...
     * @param input The message data attached to the transaction.
     */
    public FeeDelegatedValueTransferMemo(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String to, String value, String input) {
        super(
                klaytnCall,
