...
public class FeeDelegatedValueTransfer extends AbstractFeeDelegatedTransaction {
     ...
     * @return FeeDelegatedValueTransfer
     */
    public static FeeDelegatedValueTransfer create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String to, String value) {
        return new FeeDelegatedValueTransfer(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, to, value);
    }
     ...
     * @param value The amount of KLAY in peb to be transferred.
     */
    public FeeDelegatedValueTransfer(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String to, String value) {
        super(
                klaytnCall,
