...
public class Cancel extends AbstractTransaction {
     ...
     * @return Cancel
     */
    public static Cancel create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures) {
        return new Cancel(klaytnCall, from, nonce, gas, chainId, signatures);
    }
     ...
     * @param signatures A Signature list
     */
    public Cancel(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures) {
        super(klaytnCall, TransactionType.TxTypeCancel.toString(), from, nonce, gas, chainId, signatures);
    }
