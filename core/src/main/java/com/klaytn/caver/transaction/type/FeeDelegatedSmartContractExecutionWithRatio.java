...
public class FeeDelegatedSmartContractExecutionWithRatio extends AbstractFeeDelegatedWithRatioTransaction {
     ...
     * @return FeeDelegatedSmartContractExecutionWithRatio
     */
    public static FeeDelegatedSmartContractExecutionWithRatio create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio, String to, String value, String input) {
        return new FeeDelegatedSmartContractExecutionWithRatio(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, feeRatio, to, value, input);
    }
     ...
     * @param input The data attached to the transaction, used for transaction execution.
     */
    public FeeDelegatedSmartContractExecutionWithRatio(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio, String to, String value, String input) {
        super(
                klaytnCall,
