...
public class FeeDelegatedValueTransferWithRatioWrapper {
     ...
     * @return FeeDelegatedValueTransferWithRatio
     */
    public FeeDelegatedValueTransferWithRatio create(String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio, String to, String value) {
        return FeeDelegatedValueTransferWithRatio.create(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, feeRatio, to, value);
    }
