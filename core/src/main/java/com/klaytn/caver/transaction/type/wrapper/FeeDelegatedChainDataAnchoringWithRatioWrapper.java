...
public class FeeDelegatedChainDataAnchoringWithRatioWrapper {
     ...
     * @return FeeDelegatedChainDataAnchoringWithRatio
     */
    public FeeDelegatedChainDataAnchoringWithRatio create(String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio, String input) {
        return FeeDelegatedChainDataAnchoringWithRatio.create(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, feeRatio, input);
    }
