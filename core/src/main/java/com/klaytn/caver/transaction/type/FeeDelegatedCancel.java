...
public class FeeDelegatedCancel extends AbstractFeeDelegatedTransaction {
     ...
     * @return FeeDelegatedCancel
     */
    public static FeeDelegatedCancel create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures) {
        return new FeeDelegatedCancel(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures);
    }
     ...
     * @param feePayerSignatures A fee payer signature list.
     */
    public FeeDelegatedCancel(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures) {
        super(
                klaytnCall,
