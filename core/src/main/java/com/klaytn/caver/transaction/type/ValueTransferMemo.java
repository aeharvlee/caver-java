...
public class ValueTransferMemo extends AbstractTransaction {
     ...
     * @return ValueTransferMemo
     */
    public static ValueTransferMemo create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String to, String value, String input) {
        return new ValueTransferMemo(klaytnCall, from, nonce, gas, chainId, signatures, to, value, input);
    }
     ...
     * @param input The message data attached to the transaction.
     */
    public ValueTransferMemo(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String to, String value, String input) {
        super(
                klaytnCall,
