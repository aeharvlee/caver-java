...
public class SmartContractDeployWrapper {
     ...
     * @return SmartContractDeploy
     */
    public SmartContractDeploy create(String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String to, String value, String input, boolean humanReadable, String codeFormat) {
        return SmartContractDeploy.create(klaytnCall, from, nonce, gas, chainId, signatures, to, value, input, humanReadable, codeFormat);
    }
