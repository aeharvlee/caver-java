...
public class FeeDelegatedSmartContractDeployWithRatio extends AbstractFeeDelegatedWithRatioTransaction {
     ...
     * @return FeeDelegatedSmartContractDeployWithRatio
     */
    public static FeeDelegatedSmartContractDeployWithRatio create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio, String to, String value, String input, boolean humanReadable, String codeFormat) {
        return new FeeDelegatedSmartContractDeployWithRatio(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, feeRatio, to, value, input, humanReadable, codeFormat);
    }
     ...
     * @param codeFormat The code format of smart contract code
     */
    public FeeDelegatedSmartContractDeployWithRatio(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio, String to, String value, String input, boolean humanReadable, String codeFormat) {
        super(
                klaytnCall,
