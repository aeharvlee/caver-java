...
public class ChainDataAnchoringWrapper {
     ...
     * @return ChainDataAnchoring
     */
    public ChainDataAnchoring create(String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String input) {
        return ChainDataAnchoring.create(klaytnCall, from, nonce, gas, chainId, signatures, input);
    }
