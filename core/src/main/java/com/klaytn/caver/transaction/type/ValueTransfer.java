...
public class ValueTransfer extends AbstractTransaction {
     ...
     * @return ValueTransfer
     */
    public static ValueTransfer create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String to, String value) {
        return new ValueTransfer(klaytnCall, from, nonce, gas, chainId, signatures, to, value);
    }
     ...
     * @param value The amount of KLAY in peb to be transferred.
     */
    public ValueTransfer(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String to, String value) {
        super(
                klaytnCall,
