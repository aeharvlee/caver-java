...
public class FeeDelegatedValueTransferWithRatio extends AbstractFeeDelegatedWithRatioTransaction {
     ...
     * @return FeeDelegatedValueTransferWithRatio
     */
    public static FeeDelegatedValueTransferWithRatio create(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio, String to, String value) {
        return new FeeDelegatedValueTransferWithRatio(klaytnCall, from, nonce, gas, chainId, signatures, feePayer, feePayerSignatures, feeRatio, to, value);
    }
     ...
     * @param value The amount of KLAY in peb to be transferred.
     */
    public FeeDelegatedValueTransferWithRatio(Klay klaytnCall, String from, String nonce, String gas, String chainId, List<SignatureData> signatures, String feePayer, List<SignatureData> feePayerSignatures, String feeRatio, String to, String value) {
        super(
                klaytnCall,
