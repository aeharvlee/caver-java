...
import com.klaytn.caver.core_android.base.LocalValues;
...
import static com.klaytn.caver.core_android.base.Accounts.BRANDON;
import static com.klaytn.caver.core_android.base.Accounts.LUMAN;
import static com.klaytn.caver.core_android.base.Accounts.WAYNE;
...
public class KIP7Test {
    ...
    public static void deployContract() throws Exception {
        Caver caver = new Caver(LocalValues.ANDROID_DEFAULT_URL);
    ...
    public static class DetectInterfaceTest {
        ...
        public static void initCaver() throws Exception {
            caver = new Caver(LocalValues.ANDROID_DEFAULT_URL);
            caver.wallet.add(caver.wallet.keyring.createFromPrivateKey("0x2359d1ae7317c01532a58b01452476b796a3ac713336e97d8d3c9651cc0aecc3"));
            KIP7Test.deployContract();
        }
