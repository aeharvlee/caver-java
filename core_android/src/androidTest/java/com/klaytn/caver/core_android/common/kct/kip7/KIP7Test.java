...
import static com.klaytn.caver.core_android.base.Accounts.*;
...
public class KIP7Test {
    ...
    static KIP7 kip7contract;
    static final String CONTRACT_NAME = "Kale";
    static final String CONTRACT_SYMBOL = "KALE";
    static final int CONTRACT_DECIMALS = 18;
    static final BigInteger CONTRACT_INITIAL_SUPPLY = BigInteger.valueOf(100_000).multiply(BigInteger.TEN.pow(CONTRACT_DECIMALS)); // 100000 * 10^18

    public KIP7 deployContract() throws Exception {
        ...
        return caver.kct.kip7.deploy(kip7DeployParam, LUMAN.getAddress());
    }
    ...
    public void setUp() throws Exception {
        ...
        caver.wallet.add(LUMAN);
        caver.wallet.add(BRANDON);
        kip7contract = deployContract();
        setUpIsDone = true;
    }
    ...
    public void cloneTestWithSetWallet() throws IOException {
        Caver caver = new Caver(ANDROID_DEFAULT_URL);
    ...
    public void setUnpause() {
        try {
            KIP7 kip7 = deployContract();
            kip7.setDefaultSendOptions(new SendOptions());
            if(kip7.paused()) {
                SendOptions options = new SendOptions(LUMAN.getAddress(), BigInteger.valueOf(4000000));
                TransactionReceipt.TransactionReceiptData receiptData = kip7.unpause(options);
            }
        } catch (Exception e) {
            e.printStackTrace();
            fail();
    ...
    public void pausedDefaultOptions() {
        try{
            KIP7 kip7 = deployContract();
            SendOptions options = new SendOptions(LUMAN.getAddress(), BigInteger.valueOf(4000000));
            kip7.setDefaultSendOptions(options);
            kip7.pause();
            assertTrue(kip7.paused());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void pausedNoDefaultGas() {
        try {
            KIP7 kip7 = deployContract();
            kip7.getDefaultSendOptions().setFrom(LUMAN.getAddress());
            kip7.pause();
            assertTrue(kip7.paused());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void unPause() {
        try {
            ...
            kip7.unpause(options);
            assertFalse(kip7.paused());
        } catch (Exception e) {
            e.printStackTrace();
            fail();
        }
    ...
    public void addPauser() {
        try {
            KIP7 kip7 = deployContract();
            SendOptions options = new SendOptions(LUMAN.getAddress(), BigInteger.valueOf(4000000));
            kip7.addPauser(BRANDON.getAddress(), options);

            assertTrue(kip7.isPauser(BRANDON.getAddress()));
        } catch (Exception e) {
            e.printStackTrace();
            fail();
        }
    ...
    public void renouncePauser() {
        try {
            KIP7 kip7 = deployContract();
            if(!kip7.isPauser(BRANDON.getAddress())) {
                SendOptions options = new SendOptions(LUMAN.getAddress(), BigInteger.valueOf(4000000));
                kip7.addPauser(BRANDON.getAddress(), options);
            }

            SendOptions options = new SendOptions(BRANDON.getAddress(), BigInteger.valueOf(4000000));
            kip7.renouncePauser(options);

            assertFalse(kip7.isPauser(BRANDON.getAddress()));
        } catch (Exception e) {
            e.printStackTrace();
            fail();
        }
    ...
    public void burn() {
        try {
            ...
            kip7.burn(new BigInteger(burnAmount), sendOptions);

            BigInteger afterSupply = kip7.totalSupply();
    ...
    public void burnFrom() {
        try {
            KIP7 kip7 = deployContract();
            BigInteger beforeBalance = kip7.balanceOf(LUMAN.getAddress());

            SendOptions sendOptions = new SendOptions(LUMAN.getAddress(), (String)null);
            String burnAmount = Utils.convertToPeb("100", "KLAY");

            kip7.approve(BRANDON.getAddress(), Numeric.toBigInt(burnAmount), sendOptions);

            kip7.burnFrom(LUMAN.getAddress(), new BigInteger(burnAmount), new SendOptions(BRANDON.getAddress(), (String)null));
            BigInteger afterBalance = kip7.balanceOf(LUMAN.getAddress());
    ...
    public void mint() {
        try {
            KIP7 kip7 = deployContract();
            BigInteger beforeTotalSupply = kip7.totalSupply();

            SendOptions sendOptions = new SendOptions(LUMAN.getAddress(), (String)null);
            String mintAmount = Utils.convertToPeb("100", "KLAY");

            kip7.mint(LUMAN.getAddress(), new BigInteger(mintAmount), sendOptions);

            BigInteger afterTotalSupply = kip7.totalSupply();
    ...
    public void addMinter() {
        try {
            KIP7 kip7 = deployContract();
            if(kip7.isMinter(BRANDON.getAddress())) {
            ...
            kip7.addMinter(BRANDON.getAddress(), sendOptions);

            assertTrue(kip7.isMinter(BRANDON.getAddress()));
        } catch (Exception e) {
            e.printStackTrace();
            fail();
        }
    ...
    public void renounceMinter() {
        try {
            ...
            assertFalse(kip7.isMinter(BRANDON.getAddress()));
        } catch (Exception e) {
            e.printStackTrace();
            fail();
        }
    ...
    public void allowance() {
        try {
            KIP7 kip7 = deployContract();
            BigInteger allowance = kip7.allowance(LUMAN.getAddress(), WAYNE.getAddress());
    ...
    public void approve() {
        try {
            KIP7 kip7 = deployContract();
            BigInteger allowance = kip7.allowance(LUMAN.getAddress(), BRANDON.getAddress());

            SendOptions sendOptions = new SendOptions(LUMAN.getAddress(), (String)null);
            BigInteger approveAmount = BigInteger.TEN.multiply(BigInteger.TEN.pow(CONTRACT_DECIMALS)); // 10 * 10^18

            kip7.approve(BRANDON.getAddress(), approveAmount, sendOptions);

            BigInteger afterAllowance = kip7.allowance(LUMAN.getAddress(), BRANDON.getAddress());
    ...
    public void transfer() {
        try {
            KIP7 kip7 = deployContract();
            BigInteger beforeBalance = kip7.balanceOf(BRANDON.getAddress());

            SendOptions sendOptions = new SendOptions(LUMAN.getAddress(), (String)null);
            BigInteger transferAmount = BigInteger.TEN.multiply(BigInteger.TEN.pow(CONTRACT_DECIMALS)); // 10 * 10^18

            kip7.transfer(BRANDON.getAddress(), transferAmount, sendOptions);

            BigInteger afterBalance = kip7.balanceOf(BRANDON.getAddress());
    ...
    public void transferFrom() {
        ...
        try{
            KIP7 kip7 = deployContract();
            //reset
            kip7.approve(BRANDON.getAddress(), BigInteger.ZERO, ownerOptions);

            //Test
            kip7.approve(BRANDON.getAddress(), allowAmount, ownerOptions);
            BigInteger preBalance = kip7.balanceOf(WAYNE.getAddress());

            kip7.transferFrom(LUMAN.getAddress(), WAYNE.getAddress(), allowAmount, allowanceOptions);
            BigInteger afterBalance = kip7.balanceOf(WAYNE.getAddress());
    ...
    public void safeTransfer() {
        ...
        try {
            ...
            kip7.safeTransfer(BRANDON.getAddress(), transferAmount, sendOptions);
    ...
    public void safeTransferWithData() {
        ...
        try {
            ...
            kip7.safeTransfer(BRANDON.getAddress(), transferAmount, data, sendOptions);
    ...
    public void safeTransferFrom() {
        ...
        try{
            ...
            kip7.safeTransferFrom(LUMAN.getAddress(), WAYNE.getAddress(), allowAmount, allowanceOptions);
            BigInteger afterBalance = kip7.balanceOf(WAYNE.getAddress());
    ...
    public void safeTransferFromWithData() {
        ...
        try{
            ...
            kip7.safeTransferFrom(LUMAN.getAddress(), WAYNE.getAddress(), allowAmount, data, allowanceOptions);
            BigInteger afterBalance = kip7.balanceOf(WAYNE.getAddress());
